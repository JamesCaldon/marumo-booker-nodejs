import webdriver, { By, Condition, ThenableWebDriver, until } from 'selenium-webdriver'
...
export class BookingBot {
    ...
    async selectDropdownOption(option: string, optionNumber: string)
    {
    ...
    async enterFormField(submissionForm: webdriver.WebElement, id: string, value: string)
    {
